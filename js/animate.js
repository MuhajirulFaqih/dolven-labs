...
//   camGUI.add(options.perlin, 'vel', 0.000, 0.0037).name('Velocity').listen();
//   //camGUI.open();
  
//   var mathGUI = gui.addFolder('Math Options');
//   mathGUI.add(options.spin, 'sinVel', 0.0, 0).name('Sine').listen();
//   mathGUI.add(options.spin, 'ampVel', 0.0, 80.00).name('Amplitude').listen();
//   //mathGUI.open();
...
$('#fragmentShader').html(`varying float qnoise;
